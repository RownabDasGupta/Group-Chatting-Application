...
public class UserOne implements ActionListener, Runnable {
    ...
    UserOne() {
        ...
        morevert.setBounds(400, 22, 10, 24);
        p1.add(morevert);
        
        JLabel name = new JLabel("Mirzapur Group");
        ...
        status.setBounds(110, 39, 160, 10);
        status.setForeground(Color.WHITE);
        status.setFont(new Font("SAN_SERIF", Font.BOLD, 10));
        p1.add(status);
        
        a1 = new JPanel();
        a1.setBounds(4, 73, 432, 550);
        a1.setBackground(Color.WHITE);
        f.add(a1);
        
        text = new JTextField();
        text.setBounds(5, 625, 325, 40);
